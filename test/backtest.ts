...
mocha.describe("BacktestTests", () => {
    ...
    mocha.it("Should handle timeouts in order", () => {
    ...
    mocha.it("Should handle intervals", () => {
        var nTimes = 0;
    ...
    mocha.it("Should handle both intervals and timouts", () => {
        var nTimes = 0;
        timeProvider.setInterval(() => nTimes += 1, Moment.duration(2, "seconds"));
...
mocha.describe("BacktestGatewayTests", () => {
    mocha.it("should read market data", () => {
